  ...
  <body>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="list-inline pull-right">
                            ...
                            <li><a href="tel:+943419818"><i class="fa fa-phone"></i> +94 71 341 98 18</a></li>
                        </ul>                        
                    </div>
    ...
    <div class="carousel-inner">
        <div class="item" style="">
            <img src="http://lorempixel.com/580/250/nature/1" alt="" class="img-responsive">
        ...
        <div class="item active">
            <img src="http://lorempixel.com/580/250/nature/2" alt="" class="img-responsive">
            <div class="carousel-caption">
        ...
        <div class="item" style="">
            <img src="http://lorempixel.com/580/250/nature/3" alt="" class="img-responsive">
            <div class="carousel-caption">
    ...
    <div class="highlightSection">
		<div class="container">
			<div class="row">
			<div class="col-md-8">
			 <h2>EXXXXXXXXXXXXXXXXXXX</h2>
			<a href="#">xxxxxxxxxxxxxxxxxxxxxxx </a>
				</p>
			</div>
			<div class="col-md-4 align-right"> 
			<h4>Responsive Design
			xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx xxxxxxxxxxxxxxxx </h4>
			<a class="btn btn btn-brand" href="/test">NAVIGATION</a>
				</p>
			</div>
			</div>
		</div>
    ...
    <div class="bodySection" style="">
		...
		<div class="row">
			...
			<div class="projectList">
				...
				<ul id="nt-example1" style="height: 100%; overflow: hidden;">
				...
				<div class="media">
				  ...
				  <div class="media-body">
					<h4 class="media-heading"><a href="#">Projects Three</a></h4>
					<p>
						On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire
					</p>
					<a class="pull-right" href="#">more details</a>
				...
				<div class="media">
				  ...
				  <div class="media-body">
					<h4 class="media-heading"><a href="#">Projects Four</a></h4>
					<p>
						On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire
					</p>
					<a class="pull-right" href="#">more details</a>
				...
				<div class="media">
				  ...
				  <div class="media-body">
					<h4 class="media-heading"><a href="#">Projects Five</a></h4>
					<p>
						On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire
					</p>
					<a class="pull-right" href="#">more details</a>
